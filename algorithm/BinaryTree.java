...
//宽度
//    public int getWidth(tree.TreeNode root)
//    {
//        if(root == null)
//        {
//            return 0;
//        }
//        int nWidth = 0;//二叉树宽度
//        int nLastLevelWidth = 0;//上一层二叉树宽度
//        int nTempLastLevelWidth = 0;//temp
//        int nCurLevelWidth = 0;//当前层二叉树宽度
//
//        Queue<tree.TreeNode> myQueue = new LinkedList<>();//建立节点队列
//        myQueue.add(root);//将头节点加入队列
//        nLastLevelWidth = 1;
//        nWidth = 1;
//
//        while(!myQueue.isEmpty())//若队列不为空
//        {
//            nTempLastLevelWidth = nLastLevelWidth;
//            tree.TreeNode tmp = null;
...
//    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("*******(先序遍历)[ABDECF]遍历*****************");
        bt.preOrder(bt.root);
